...
\author{Mateusz Wyszyński \\ Lazarski University \\ University of Warsaw
\and Krzysztof Beck \\ Lazarski University
...
\end{Sinput}
\end{Schunk}
\includegraphics{bdsm_vignette-017}
...
\end{Soutput}
\end{Schunk}
\includegraphics{bdsm_vignette-022}
...
\end{Sinput}
\end{Schunk}
\includegraphics{bdsm_vignette-026}
...
\end{Sinput}
\end{Schunk}
\includegraphics{bdsm_vignette-031}
...
\end{Sinput}
\end{Schunk}
\includegraphics{bdsm_vignette-037}
...
\end{Sinput}
\end{Schunk}
\includegraphics{bdsm_vignette-043}
