...
The core function of the package, \verb+find_model_space+,
...
\begin{Soutput}
                 [,1]        [,2]        [,3]        [,4]        [,5]
alpha      1.07378465  1.03327423  1.09699068  1.06474399  1.05204753
phi_0     -0.06464413 -0.05552208 -0.11838487 -0.10693787 -0.06367009
err_var    0.08591288  0.05245495  0.07283330  0.03292191  0.07995519
dep_var_1  0.19798629  0.16630341  0.19857386  0.17107350  0.19228224
dep_var_2  0.17974088  0.18702348  0.18154058  0.18901376  0.17912017
dep_var_3  0.16966304  0.17027272  0.17096556  0.17184226  0.16944294
dep_var_4  0.16579188  0.16979908  0.16805065  0.17319513  0.16609665
beta_ish           NA  0.11977917          NA  0.12528254          NA
beta_sed           NA          NA -0.02673004 -0.01380084          NA
beta_pgrw          NA          NA          NA          NA  0.00894421
\end{Soutput}
\end{Schunk}
...
\begin{Soutput}
               [,1]          [,2]          [,3]          [,4]          [,5]
 [1,] -4.051096e+02 -318.60683164 -3.331542e+02 -241.95897629 -3.365331e+02
 [2,]  3.741277e-03    0.01176953  9.643031e-03    0.03234965  9.206861e-03
 [3,]  8.276070e-02    0.08045785  9.801465e-02    0.10480244  7.889298e-02
 [4,]  0.000000e+00    0.02915489  0.000000e+00    0.03019487  0.000000e+00
 [5,]  0.000000e+00    0.00000000  6.478837e-02    0.06405320  0.000000e+00
 [6,]  0.000000e+00    0.00000000  0.000000e+00    0.00000000  3.613447e-02
...
[13,]  7.261087e-02    0.13177084  1.372106e-01    0.23233329  7.911811e-02
[14,]  0.000000e+00    0.07630241  0.000000e+00    0.08106997  0.000000e+00
[15,]  0.000000e+00    0.00000000  1.105686e-01    0.11441947  0.000000e+00
[16,]  0.000000e+00    0.00000000  0.000000e+00    0.00000000  6.200825e-02
...
The \verb+find_model_space+ function
...
Even with parallelization, \verb+find_model_space+ call may be time-consuming.
...
the object obtained with the \verb+find_model_space+ function.
...
\end{Sinput}
\end{Schunk}
\includegraphics{bdsm_vignette-018}
...
\end{Sinput}
\end{Schunk}
\includegraphics{bdsm_vignette-020}
...
\end{Sinput}
\end{Schunk}
\includegraphics{bdsm_vignette-027}
...
\end{Sinput}
\end{Schunk}
\includegraphics{bdsm_vignette-032}
...
\end{Sinput}
\end{Schunk}
\includegraphics{bdsm_vignette-033}
...
\end{Sinput}
\end{Schunk}
\includegraphics{bdsm_vignette-038}
...
\end{Sinput}
\end{Schunk}
\includegraphics{bdsm_vignette-039}
...
\end{Sinput}
\end{Schunk}
\includegraphics{bdsm_vignette-044}
...
\end{Sinput}
\end{Schunk}
\includegraphics{bdsm_vignette-045}
...
\end{Sinput}
\end{Schunk}
\includegraphics{bdsm_vignette-046}
